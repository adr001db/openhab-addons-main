...
/**
 * The {@link OnectaHandlerFactory} is responsible for creating things and thing
 * handlers.
 *
...
public class OnectaHandlerFactory extends BaseThingHandlerFactory {
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (THING_TYPE_SAMPLE.equals(thingTypeUID)) {
            return new OnectaHandler(thing);
        }
